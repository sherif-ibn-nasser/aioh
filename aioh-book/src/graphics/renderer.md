...
The Renderer is the central component responsible for drawing all graphical elements. It manages the shaders, vertex
buffers, and textures to ensure efficient rendering.
